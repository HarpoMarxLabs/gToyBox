...
func RunExamples() {
	...
	fmt.Println("AtomicExample")
	gobyexample.AtomicExamples()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("B64EncExample")
	gobyexample.B64EncExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("ChannelDirectExample")
	gobyexample.ChannelDirectExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("ChannelExample")
	gobyexample.ChannelExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("ChannelSyncExample")
	gobyexample.ChannelSyncExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("ClosingChannelExample")
	gobyexample.ClosingChannelExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("ClosuresExample")
	gobyexample.ClosureExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("CommandLineArgsExample")
	gobyexample.CommandLineArgsExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("ComLineExample")
	gobyexample.ComLineExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("CollectionFuncExample")
	gobyexample.CollectionFuncExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("Constants Example")
	gobyexample.ConstantsExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("DefereExample")
	gobyexample.DefereExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("Envars Example")
	gobyexample.EnvarsExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("Epic Example")
	gobyexample.EpicExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("Errors Example")
	gobyexample.ErrorsExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("ExecInProcess Example")
	gobyexample.ExecInProcessExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("ExitExample Example")
	gobyexample.ExitExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("ForExample Example")
	gobyexample.ForExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("FunctionExample Example")
	gobyexample.FunctionExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("GorutineExample Example")
	gobyexample.GorutineExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("IfElseExample Example")
	gobyexample.IfElseExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("InterfaceExample Example")
	gobyexample.InterfaceExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("JsonExample Example")
	gobyexample.JsonExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("LineFilterExample Example")
	gobyexample.LineFilterExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("MapsExample Example")
	gobyexample.MapsExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("MethodsExample Example")
	gobyexample.MethodsExample()
	fmt.Println(strings.Repeat("#", 30))

	fmt.Println("MultipleReturnsExample Example")
